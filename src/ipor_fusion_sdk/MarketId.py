class MarketId:
  ...
  def __eq__(self, other):
    if not isinstance(other, MarketId):
      return False
    return self._protocol_id == other._protocol_id and self._market_id == other._market_id

  def __hash__(self):
    return hash((self._protocol_id, self._market_id))

  def __str__(self):
    return f"MarketId[protocolId='{self._protocol_id}', marketId='{self._market_id}']"
